install.packages("ggplot2")             #für Barcharts
library(ggplot2)
library(tidyr)
install.packages("wordcloud2")          # Für Wordclouds
library(wordcloud2)
install.packages("data.table")           # für Tables
library("data.table")

#----------dieses script visualisiert die term frequncy der filter und gibt die Logliklihood table.
#----------------------------#Results: filter2
...
#------------------------------filter 1 Visualisieurng: 


#Bevor wir an die Loglikelihood Visualisierung gehen, sortieren wir auch die Liste vor:
#nach > 0 und
...
#filter den vector für dies "sinnhaften wörter
...
#jetzt noch die wordcounts Visualisieren: 
#Aber erst, wieder nach sinnvollen Wörtern schauen und filtern
...
# jetzt Visulaisierung: z.b wordclouds
