...
#ideen: Keywordsanalyse, um sinnvolle Keywords zu finden --> relativ viel arbeit, da keywords aufgesplittet werden müssten. Außerdem nicht wirklich ergibig
#Pattern ergänzen um auch andere Schreibarten miteinzubeziehen
# n-gram Suche um die Regex Treffer reum, um herauszufinden wie der Kontext der Verwendung war
#was ist mit den Süddeutsche daten?



# Define the search pattern for title, url, description and keyords
