...
gender-inklusive Sprache|gender inklusive Sprache|feministische Sprache|geschlechtsspezifische Sprache|
...
# Subset the dataframes to only include rows where the search pattern appears columns
